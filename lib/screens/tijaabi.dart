...
class tijaabiPage extends StatefulWidget {
  String maqal;
  String name;
  String cover;

  tijaabiPage(this.maqal, this.name, this.cover);

  @override
  State<tijaabiPage> createState() => _tijaabiPageState();
}

class _tijaabiPageState extends State<tijaabiPage> {
